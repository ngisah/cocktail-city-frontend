  ...
  return (
    <div>
        ...
        <p className='web-description'>
          "If you are in need of strong yet sweet Cocktails then look no further! Cocktail City has amazing Cocktail recipes for you to try and enjoy. You can also save your favorites recipes by clicking on <em>"Add A Cocktail"</em> at the top of the website. "
        </p>
    </div>
  );
};
